...
**Question 7**: The large graph is the assemble of the chromosome, and the smaller one is the assembly of the plasmid in this strain. Look at the plasmid graph (the smaller graph at the bottom of the screen). What colour are the nodes in this graph? Why might this be?
