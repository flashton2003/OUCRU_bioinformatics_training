...
author: "Liz Batty"
description: "Adapted from http://rik.smith-unna.com/command_line_bootcamp/ "
...
Open up the program `mobaXterm` on your computer. You have been given the IP address of your computer (four sets of numbers separated by dots) and a password. Type the following into your `mobaXterm` window:

<pre class="bash">
ssh ubuntu@137.44.59.149
</pre>

replacing 137.44.59.149 with the IP address you have been given. When you hit Enter, you will be asked for your password. Type this in and hit Enter.
...
(base) ubuntu@liz-workshop-demo:~$

</pre>

This is called the command prompt. It shows you the username you have used to connect to the server (in this case 'ubuntu') and the name of the machine (my machine is called 'liz-workshop-demo'), and the directory where you are (in this case, '~' - more about this later). The $ marks the end of the command prompt.
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~$ ls
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~$ ls /etc/perl
CPAN  Net  XML
(base) ubuntu@liz-workshop-demo:~$
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~$ pwd
/home/ubuntu
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~$ mkdir learning_unix
(base) ubuntu@liz-workshop-demo:~$ ls
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~$ cd learning_unix/
(base) ubuntu@liz-workshop-demo:~/learning_unix$
</pre>

Let's make two new subdirectories and navigate into them:

<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ mkdir outer
(base) ubuntu@liz-workshop-demo:~/learning_unix$ cd outer
(base) ubuntu@liz-workshop-demo:~/learning_unix/outer$

(base) ubuntu@liz-workshop-demo:~/learning_unix/outer$ mkdir inner
(base) ubuntu@liz-workshop-demo:~/learning_unix/outer$ cd inner/
(base) ubuntu@liz-workshop-demo:~/learning_unix/outer/inner$
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix/outer/inner$ cd /
(base) ubuntu@liz-workshop-demo:/$ cd home
(base) ubuntu@liz-workshop-demo:/home$ cd ubuntu
(base) ubuntu@liz-workshop-demo:~$
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~$ cd learning_unix/
(base) ubuntu@liz-workshop-demo:~/learning_unix$ cd ..
(base) ubuntu@liz-workshop-demo:~$ cd ..
(base) ubuntu@liz-workshop-demo:/home$
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ cd ../../../tmp
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ cd ~/learning_unix/outer/
(base) ubuntu@liz-workshop-demo:~/learning_unix/outer$ ls ../../
anaconda2  data  Desktop  galaxy-app  galaxy-indices  galaxy-tools  learning_unix  ncbi  scripts
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ ls -l /home
total 24
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ cd ~/learning_unix/outer/
(base) ubuntu@liz-workshop-demo:~/learning_unix/outer$ rmdir inner/
(base) ubuntu@liz-workshop-demo:~/learning_unix/outer$ cd ..
(base) ubuntu@liz-workshop-demo:~/learning_unix$ rmdir outer/
(base) ubuntu@liz-workshop-demo:~/learning_unix$ ls
(base) ubuntu@liz-workshop-demo:~/learning_unix$
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ touch heaven.txt
(base) ubuntu@liz-workshop-demo:~/learning_unix$ touch earth.txt
(base) ubuntu@liz-workshop-demo:~/learning_unix$ ls
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ mkdir temp
(base) ubuntu@liz-workshop-demo:~/learning_unix$ mv heaven.txt temp/
(base) ubuntu@liz-workshop-demo:~/learning_unix$ mv earth.txt temp/
(base) ubuntu@liz-workshop-demo:~/learning_unix$ ls
temp
(base) ubuntu@liz-workshop-demo:~/learning_unix$ ls temp/
earth.txt  heaven.txt
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ touch rags
(base) ubuntu@liz-workshop-demo:~/learning_unix$ ls
rags  temp
(base) ubuntu@liz-workshop-demo:~/learning_unix$ mv rags temp/riches
(base) ubuntu@liz-workshop-demo:~/learning_unix$ ls temp/
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ mv temp/riches temp/rags
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ mkdir temp2
(base) ubuntu@liz-workshop-demo:~/learning_unix$ mv temp2 temp
(base) ubuntu@liz-workshop-demo:~/learning_unix$ ls temp/
...
<div class="toggle"><button>Answer</button>
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ mkdir temp3
(base) ubuntu@liz-workshop-demo:~/learning_unix$ cd /tmp
(base) ubuntu@liz-workshop-demo:/tmp$ mv ~/learning_unix/temp3 ~/learning_unix/temp/temp2
(base) ubuntu@liz-workshop-demo:/tmp$ cd ~/learning_unix/
(base) ubuntu@liz-workshop-demo:~/learning_unix$ ls temp/temp2/
temp3
</pre>
</div><br>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ cd temp
(base) ubuntu@liz-workshop-demo:~/learning_unix/temp$ ls
earth.txt  heaven.txt  rags  temp2
(base) ubuntu@liz-workshop-demo:~/learning_unix/temp$ rm -i earth.txt heaven.txt rags
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix/temp$ rmdir temp2/temp3/
(base) ubuntu@liz-workshop-demo:~/learning_unix/temp$ rmdir temp2/
(base) ubuntu@liz-workshop-demo:~/learning_unix/temp$ cd ..
(base) ubuntu@liz-workshop-demo:~/learning_unix$ rmdir temp/
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ touch file1
(base) ubuntu@liz-workshop-demo:~/learning_unix$ cp file1 file2
(base) ubuntu@liz-workshop-demo:~/learning_unix$ ls
file1  file2
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ touch ~/file3
(base) ubuntu@liz-workshop-demo:~/learning_unix$ ls ~
anaconda2  data  Desktop  file3  galaxy-app  galaxy-indices  galaxy-tools  learning_unix  ncbi  scripts
(base) ubuntu@liz-workshop-demo:~/learning_unix$ cp ~/file3 .
(base) ubuntu@liz-workshop-demo:~/learning_unix$ ls
file1  file2  file3
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ rm file*
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ echo "Call me Ishmael."
Call me Ishmael.
(base) ubuntu@liz-workshop-demo:~/learning_unix$ echo "Call me Ishmael." > opening_lines.txt
(base) ubuntu@liz-workshop-demo:~/learning_unix$ ls
opening_lines.txt
(base) ubuntu@liz-workshop-demo:~/learning_unix$ less opening_lines.txt
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ echo "The primroses were over." >> opening_lines.txt
(base) ubuntu@liz-workshop-demo:~/learning_unix$ cat opening_lines.txt
Call me Ishmael.
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ cat opening_lines.txt > file_copy.txt
(base) ubuntu@liz-workshop-demo:~/learning_unix$ less file_copy.txt
</pre>

And again, let's clean up the redundant file:
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ rm file_copy.txt
</pre>
...
(base) ubuntu@liz-workshop-demo:~/learning_unix$ ls -l
total 4
-rw-rw-r-- 1 ubuntu ubuntu 42 Mar 20 08:52 opening_lines.txt

(base) ubuntu@liz-workshop-demo:~/learning_unix$ wc opening_lines.txt
 2  7 42 opening_lines.txt
 
(base) ubuntu@liz-workshop-demo:~/learning_unix$ wc -l opening_lines.txt
2 opening_lines.txt
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ nano opening_lines.txt
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ grep was opening_lines.txt
The Galactic Empire was dying.
It was a pleasure to burn.
It was a bright, cold day in April, and the clocks were striking thirteen.
It was love at first sight.
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ grep -v was opening_lines.txt
Call me Ishmael.
The primroses were over.
Now is the winter of our discontent.
All children, except one, grow up.
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ grep all opening_lines.txt
Call me Ishmael.
(base) ubuntu@liz-workshop-demo:~/learning_unix$ grep -i all opening_lines.txt
Call me Ishmael.
All children, except one, grow up.
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ grep in opening_lines.txt
Now is the winter of our discontent.
The Galactic Empire was dying.
In a hole in the ground there lived a hobbit.
It was a bright, cold day in April, and the clocks were striking thirteen.
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ grep -w o.. opening_lines.txt
Now is the winter of our discontent.
All children, except one, grow up.

(base) ubuntu@liz-workshop-demo:~/learning_unix$ grep [aeiou]t opening_lines.txt
In a hole in the ground there lived a hobbit.
It was love at first sight.
It was the day my grandmother exploded.
When he was nearly thirteen, my brother Jem got his arm badly broken at the elbow.
...
(base) ubuntu@liz-workshop-demo:~/learning_unix$ grep -w -i [aeiou]t opening_lines.txt
It was a pleasure to burn.
It was a bright, cold day in April, and the clocks were striking thirteen.
It was love at first sight.
It was the day my grandmother exploded.
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ grep was opening_lines.txt | wc -c
316
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ grep was opening_lines.txt | sort | head -n 3 | wc -c
130
</pre>
...
<pre class="bash">
(base) ubuntu@liz-workshop-demo:~/learning_unix$ echo $USER
ubuntu
(base) ubuntu@liz-workshop-demo:~/learning_unix$ echo $HOME
/home/ubuntu
(base) ubuntu@liz-workshop-demo:~/learning_unix$ echo $PATH
