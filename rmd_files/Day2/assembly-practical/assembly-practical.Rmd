...
**Q1: Look at the fastq files. How long are the sequencing reads?

Now we will run spades to assemble the genome: 

```spades.py -1 rawdata/S_aureus_1.fastq.gz  -2 rawdata/S_aureus_2.fastq.gz -o S_aureus --careful -t 4```

We will run spades with the `--careful setting` which aims to minimise the number of errors.

**Q2: How many cores is this assembly using? How would you change this?**

Spades will take around 15 minutes  to run. When spades has finished, look at the output files which are produced. 


**Q3: Can you tell which k-mers Spades used for the assembly?**
...
**Q4: How many contigs (over 500bp) are there in the two assemblies? What is the n50 value for the two assemblies?**
...
**Q5: how many completely separate assembly graphs have been drawn? Why could you have multiple disconnected graphs?**
...
**Q6: What do you notice about the colour of the short nodes and the long nodes in the chromosome graph? Why might this be?**

**Q7: Look at the plasmid graph (the smaller graph at the bottom of the screen). What colour are the nodes in this graph? Why might this be?**
...
**Q8: How many contigs are in the assemblies? How does this compare to our *S. aureus* assembly?**
