...
More on pairwise SNP distances in lecture.
</div>
...
* Download the tree (the file you want is the one which ends in `.treefile`) to your local computer, you can either do this with filezilla or by using `cat` to print the contents of the file to screen and then copy and pasting it into a new file on your local computer. Make sure that the file extension of the tree file is `.nwk`.
...
* `In FigTree`, go to `File -> Import annotations` in the menu bar, and navigate to the `outbreak_practical/phylo/dataset2/annot.txt` file. Select this file and press open. Then in the main `FigTree` window, go to `Tip Lables`, and in the drop down `Display` menu, select ANNOT. You should now be able to see tip labels containing information about continent, country and year on the tree.
...
**Question 4:**  What do you think happened with ERR466848?

<textarea id="name" name="name" cols="100" rows="3" placeholder="You can input your answer here..."/>

Answer - transmission from Haiti to Mexico? From Nepal to Mexico?

**Question 5:** Do all the genomes from Nepal form a monophyletic group? What does this tell you about cholera in Nepal?

<textarea id="name" name="name" cols="100" rows="3" placeholder="You can input your answer here..."/>

Answer - No. Tells you that there are multiple circulating cholera clones/clades in Nepal.

**Question 6:** What does the root of the tree represent?
...
**Question 7:**  What is the impact of this extra context on your report to the public health doctors? Write a short paragraph reporting your conclusions.
